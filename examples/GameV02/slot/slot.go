...
func NewSlot() *Slot {
	return &Slot{
		...
		Reels: [][]int{
			[]int{1, 7, 7, 9, 1, 8, 5, 0, 6, 0, 4, 1, 2, 9, 8, 4, 1, 5, 7, 6, 5, 6, 8, 8, 7, 7, 7, 8, 0, 5, 1, 8, 7, 1, 9, 6, 7, 1, 5, 6, 3, 0, 4, 3, 3, 7, 8, 4, 9, 3},
			[]int{7, 1, 9, 9, 0, 5, 8, 8, 3, 5, 1, 0, 5, 6, 6, 8, 1, 2, 3, 6, 3, 6, 2, 8, 7, 4, 7, 3, 6, 0, 3, 3, 7, 3, 1, 9, 3, 3, 1, 2, 8, 6, 6, 7, 0, 3, 2, 3, 5, 8},
			[]int{5, 1, 5, 7, 7, 0, 0, 5, 0, 2, 8, 3, 1, 2, 4, 7, 7, 7, 1, 4, 6, 2, 1, 9, 6, 0, 3, 6, 9, 1, 2, 5, 5, 0, 7, 9, 8, 8, 4, 3, 4, 7, 2, 2, 6, 9, 0, 6, 1, 6},
			[]int{0, 1, 4, 4, 5, 3, 1, 0, 2, 8, 7, 1, 8, 4, 2, 3, 2, 8, 3, 8, 6, 0, 5, 0, 4, 2, 7, 5, 1, 9, 0, 3, 0, 9, 0, 3, 0, 4, 7, 0, 5, 2, 9, 0, 8, 6, 5, 6, 0, 6},
			[]int{9, 2, 1, 7, 6, 0, 9, 2, 7, 2, 8, 1, 3, 8, 8, 6, 9, 7, 7, 2, 5, 1, 3, 5, 7, 3, 0, 6, 6, 2, 0, 0, 2, 9, 1, 0, 0, 9, 4, 4, 0, 1, 1, 7, 6, 0, 9, 7, 3, 1},
		},
	}
}
